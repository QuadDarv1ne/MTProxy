...
> **Актуально на:** 28 марта 2026 г. (utils.c/h — централизация утилит)
> **Коммит:** 7ecf5ce (HEAD → dev/master) — docs: todo.md — устранение дублирования утилит (8 файлов)
> **Версия:** v1.0.15-webui-plugins-tests
> **Статус:** ✅ Utils централизация ✅ Устранение дублирования ✅ Анализ памяти ✅ Ветки синхронизированы
> **Ветки:** dev = origin/dev ✅ | master = origin/master ✅ (синхронизированы, 7ecf5ce)
...
- [ ] Оптимизация аллокаций памяти
  - [ ] Уменьшить итерации в тестах в 10 раз для Windows
...
- [ ] Уменьшение итераций для Windows
- [ ] Добавление флага `--quick`
- [ ] Оптимизация выделения памяти (пулы)

---

*Последнее обновление: 28 марта 2026 г. (utils.c/h централизация + устранение дублирования, коммит 7ecf5ce)*
