...
**Git статус:** Готов к коммиту - vectorized-crypto.c и windows-stubs.c исправлены
...
- Ветка dev имеет локальные изменения (vectorized-crypto.c, windows-stubs.c)
- Требуется проверка сборки и тестов перед отправкой в main
