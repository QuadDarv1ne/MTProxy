...
> **Коммит:** 4244243 (HEAD -> dev, origin/master, origin/dev)
> **Версия:** v1.0.28 ✅
...
|--------|-----------|--------|
| Бенчмарки 100K+ | 🔴 Высокий | Ожидает |
...
*Последнее обновление: 29 марта 2026 г. — io_uring + тесты, готов к релизу v1.0.28*
