...
> **Коммит:** 1cd318c (HEAD -> dev, origin/master, origin/dev)
> **Версия:** v1.0.28 ✅
...
|--------|-----------|--------|
| Интеграционные тесты | 🔴 Высокий | Ожидает |
...
*Последнее обновление: 29 марта 2026 г. — io_uring + тесты + бенчмарки, готов к релизу v1.0.28*
