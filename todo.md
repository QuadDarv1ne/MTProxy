...
- **Веток:** 2 (master, dev) — ✅ синхронизированы (901d266)
- **Файлов в system/:** 82
...
- **Последняя сборка:** mtproxy-0.02, gcc 13.3.0, commit 901d266
...
- **Стабильность:** 11 коммитов в марте, все изменения протестированы
- **POSIX совместимость:** posix-compat-windows.h для Windows (mmap, fork, сигналы)
- **Тесты:** 45 тестов пройдено (100%)

---

*Последнее обновление: 19 марта 2026 г. (стабильная версия 901d266, тесты 45/45)*
