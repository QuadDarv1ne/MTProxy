...
> **Коммит:** 166b6eb (HEAD -> dev, origin/master, origin/dev)
> **Версия:** v1.0.28 ✅
...
- [x] **io_uring** — ✅ ГОТОВО (net/io_uring.c/h — ~450 строк, ENABLE_IOURING)
...
| Бенчмарки 100K+ | 🟡 Средний | Ожидает |
...
*Последнее обновление: 29 марта 2026 г. — io_uring реализован, готов к релизу v1.0.28*
