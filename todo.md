...
- [ ] **ASan тесты** — проверка утечек памяти
- [ ] **Оптимизация бинарника** — уменьшить размер (сейчас ~85MB)
- [ ] **Windows benchmark** — тесты производительности для ML систем
- [ ] **Production интеграция** — развёртывание и мониторинг
- [ ] **Тестовое покрытие** — расширить coverage для критичных модулей
