...
> **Коммит:** 160a89f (HEAD -> dev, origin/master, origin/dev)
> **Версия:** v1.0.28 ✅
...
|--------|--------|-----------|--------|
| metrics_collector тесты | v1.0.29 | 🟡 Средний | Ожидает |
| Docker интеграция | v1.0.29 | 🟢 Низкий | Ожидает |
...
*Последнее обновление: 29 марта 2026 г. — v1.0.28 готов к релизу (476 коммитов)*
