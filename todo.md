...
> **Коммит:** 4ff163f (HEAD -> dev, origin/master, origin/dev)
...
- [x] CTest интеграция — ✅ 9 тестов зарегистрировано
- [x] test_common.h — ✅ единый тестовый фреймворк
...
|--------|--------|-----------|--------|
| Интеграционные тесты | v1.0.29 | 🔴 Высокий | В работе |
...
*Последнее обновление: 29 марта 2026 г. — test_common.h создан (485 коммитов)*
