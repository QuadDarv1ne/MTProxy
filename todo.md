...
> **Коммит:** ba48774 (HEAD -> dev, origin/master, origin/dev)
...
### 🔴 Критичные
- [ ] **VERSION файл** — обновить с 1.0.1 на 1.0.28 (критично для релиза)
...
|--------|-----------|--------|
| VERSION файл | 🔴 Критичный | Ожидает |
...
*Последнее обновление: 29 марта 2026 г. — WebUI и HTTP/3 готовы, VERSION требует обновления*
