...
- [ ] **Health checks** — проверка здоровья узлов кластера
...
|---------|----------|-----------|
| **Всего коммитов** | 499 | +1 |
| **C/H файлов** | 418+ | +3 (mtcli.c/h, test_cli.c) |
| **Workflow** | 8 | 0 |
| **Тестов** | 150 (130 C + 8 Python + 4 Dart) | +10 C |
| **Бенчмарков** | 9 | 0 |
| **Документов** | 35 | +1 (CLI_GUIDE.md) |
...
*Последнее обновление: 29 марта 2026 г. — CLI утилита v1.0.0 (499 коммитов)*
