...
#### 🆕 Обновления (25 марта 2026)

##### Docker и контейнеризация
- 🐳 **Multi-arch Docker образы** — linux/amd64, linux/arm64, linux/arm/v7
- 📦 **Production-ready docker-compose** с мониторингом (Prometheus + Grafana)
- 🔒 **Security hardening** — non-root пользователь, cap_drop, read-only fs
- 🏷️ **OCI метки** для соответствия стандартам
...
- 📊 **JSON формат** — интеграция с SIEM системами (Splunk, ELK, Graylog)
- ⚡ **Асинхронная запись** — минимальное влияние на производительность

##### REST API
- 🌐 **HTTP REST API** — управление прокси через HTTP
- 🔐 **Bearer token аутентификация** — безопасный доступ к API
- 📈 **Prometheus метрики** — интеграция с системами мониторинга
- 🔄 **CORS поддержка** — доступ из веб-приложений
- 🚦 **Rate limiting** — защита от злоупотреблений

##### Система плагинов
- 🔌 **Динамические плагины** — загрузка .so файлов во время выполнения
- 🎣 **20+ точек расширения** — подключения, данные, безопасность, MTProto
...
### 📊 Статистика проекта (Март 2026, обновление 25.03)
...
| **Плагинов** | ✅ Example plugin |
| **Audit logging** | ✅ 12 категорий событий |
